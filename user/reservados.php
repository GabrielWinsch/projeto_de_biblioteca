<?php
    ...
    $erro = array('0'=> array('tit_obra'=>'','nome_autor'=>'','data_reserva'=>'','data_retirada'=>'', 'cod_aluno'=>'', 'cod_reserva'=>''));
    ...
    WHERE al.nome_aluno = '$aluno' AND r.cancelada = 'N' AND r.finalizada = 'N' ORDER BY o.tit_obra";
                    ...
                    <table>
                        ...
                        <?php foreach($obras as $obra): ?>
                            <tr>
                                ...
                                <td><a class="brand-text" href="reservados.php<?php $id = $obra['cod_reserva']; if($id > 0){echo "?id=".$id;}?>">Cancelar Reserva</a></td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>            
                    </table>
